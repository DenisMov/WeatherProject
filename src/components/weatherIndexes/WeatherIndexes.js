    ...
    const fetchData = async () => {
      try {
        const res = await getResource(
          `https://api.weatherapi.com/v1/forecast.json?key=d4482eb276b541a8a1b161131240804&q=${city}&days=5&aqi=yes&alerts=no`
        );
        setWeatherData({
      ...
      <div className="weather__static">
        <div className="weather__firstblock">
          ...
          <div className="weather__firstblock-sunriseblock">
            <div className="weather__firstblock-sunblock">
              ...
              <p className="weather__firstblock-sunrise">
                Sunrise <br /> {sunriseAm}
              </p>
            </div>
            ...
            <div className="weather__firstblock-sunblock">
              ...
              <p className="weather__firstblock-sunset">
                Sunset <br /> {sunsetAm}
              </p>
            </div>
          </div>
        ...
        <div className="weather__thirdblock">
          <div className="weather__thirdblock-humidity">
            ...
            <p className="weather__thirdblock-huminterest">
              {humidityPercent}%{" "}
            </p>
          ...
          <div className="weather__thirdblock-wind">
            ...
            <p className="weather__thirdblock-windinterest">
              {windIndexes}km/h
            </p>
          ...
          <div className="weather__thirdblock-pressblock">
            ...
            <p className="weather__thirdblock-pressinterest">
              {pressureIndexes}hPa
            </p>
